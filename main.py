...
def main():
    ...
    print(Fore.RED)
    print(f"if it gets stuck, just wait")
...
Input: """))
    ...
    thr = int(
        input(
            "\nThreads ( Default '1' | choose number 1 = "))
    print("STARTING" * 1)
    for _ in range(thr):
    ...
    while True:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f" [ {dt.hour}:{dt.minute}:{dt.second} ] your account getting banned ！！"
                )
                break
                sys.exit(0)
                ...
                print(
                    f" [ {response.status_code} ] this is not banned ruzXploit")
